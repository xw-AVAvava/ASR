...
```text
local audio file: 多人对话.wav
local reference transcript: 多人对话文本.txt
```

The audio file is used for local experiments only and is not committed to the GitHub repository.
